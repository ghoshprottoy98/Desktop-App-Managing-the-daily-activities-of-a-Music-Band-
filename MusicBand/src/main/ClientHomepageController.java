...
public class ClientHomepageController implements Initializable {
    ...
    @FXML
    private void searchBand(ActionEvent event)  throws IOException {

        Parent root = FXMLLoader.load(getClass().getResource("SearchBand.fxml"));
        Scene scene = new Scene(root);
        Stage primaryStage = new Stage();
        primaryStage.setTitle("SearchBand");
    ...
    @FXML
    private void giveReview(ActionEvent event)  throws IOException {
